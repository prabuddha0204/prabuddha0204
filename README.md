...
# PRABUDDHA SAXENA
**ECE @ JIIT '28 · Noida, India**

---
 
```
I WORK WHERE HARDWARE MEETS INTELLIGENCE.
Embedded C/C++ on Arduino · YOLOv8 pipelines · RAG backends · Full-stack web.
Currently interning at SSPL, DRDO — India's compound semiconductor research lab.
```
 
---

`EMBEDDED SYSTEMS ` &nbsp; `COMPUTER VISTION` &nbsp; `RAG / LLMs` &nbsp; `FULL STACK` &nbsp; `DSA`
...
##  STATS
<div align="center">
<img src="https://github-readme-stats.vercel.app/api?username=prabuddha0204&show_icons=true&theme=github_dark&hide_border=true&rank_icon=github&cache_seconds=86400" height="155"/>
&nbsp;&nbsp;
